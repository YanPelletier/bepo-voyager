...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [5] = LAYOUT_voyager(
    KC_ESCAPE,      TD(DANCE_7),    TD(DANCE_8),    TD(DANCE_9),    TD(DANCE_10),   TD(DANCE_11),                                   TD(DANCE_16),   TD(DANCE_17),   TD(DANCE_18),   TD(DANCE_19),   TD(DANCE_20),   TD(DANCE_21),   
...
const uint16_t PROGMEM combo1[] = { TD(DANCE_0), TD(DANCE_0), TD(DANCE_0), COMBO_END};
const uint16_t PROGMEM combo2[] = { MT(MOD_LSFT, BP_E), MT(MOD_RSFT, BP_T), COMBO_END};
